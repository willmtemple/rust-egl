...
pub const EGL_CONTEXT_CLIENT_VERSION: c_uint = 0x3098;
pub const EGL_NO_CONTEXT: c_uint = 0;
pub const EGL_DEFAULT_DISPLAY: c_uint = 0;
pub const EGL_NONE: c_uint = 0x3038;  // Attrib list terminator
pub const EGL_NO_DISPLAY: c_uint = 0;
pub const EGL_TRUE: c_uint = 1;
pub const EGL_FALSE: c_uint = 0;
pub const EGL_NO_SURFACE: c_uint = 0;
pub const EGL_SURFACE_TYPE: c_uint = 0x3033;
pub const EGL_WINDOW_BIT: c_uint = 0x0004;     // EGL_SURFACE_TYPE mask bits
pub const EGL_RENDERABLE_TYPE: c_uint = 0x3040;
pub const EGL_OPENGL_ES2_BIT: c_uint = 0x0004; // EGL_RENDERABLE_TYPE mask bits
pub const EGL_HEIGHT: c_uint = 0x3056;
pub const EGL_WIDTH: c_uint = 0x3057;

pub const EGL_BUFFER_SIZE: c_uint = 0x3020;
pub const EGL_DEPTH_SIZE: c_uint = 0x3025;
pub const EGL_ALPHA_SIZE: c_uint = 0x3021;
pub const EGL_BLUE_SIZE: c_uint = 0x3022;
pub const EGL_GREEN_SIZE: c_uint = 0x3023;
pub const EGL_RED_SIZE: c_uint = 0x3024;

pub const EGL_DRAW: EGLint = 0x3059;

pub const EGL_CONTEXT_MAJOR_VERSION_KHR: c_uint = 0x3098;
pub const EGL_CONTEXT_MINOR_VERSION_KHR: c_uint = 0x30FB;
pub const EGL_CONTEXT_FLAGS_KHR: c_uint = 0x30FC;
pub const EGL_OPENGL_ES3_BIT_KHR: c_uint = 0x0040;
pub const EGL_EXTENSIONS: c_uint = 0x3055;
